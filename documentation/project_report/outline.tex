% TODO: Fix outline (default template are not so great) so different sections can be in different body
...
\fancyhead{}
\fancyhead[L]{CS 4287 Fall 2021}
\fancyhead[R]{Baxter, Callandriello, Hicks, Pena} 
\fancyfoot{}
\fancyfoot[C]{\thepage}
